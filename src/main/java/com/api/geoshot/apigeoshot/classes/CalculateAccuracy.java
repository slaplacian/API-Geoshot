...
/**
 * Class which has one static method that calculates a User attempt accuracy.
 */
public class CalculateAccuracy {
    ...
    /**
     * Static method that compares 2 values and return a accuracy.
     * @param correctValue OBS.: this is STRING Object. The correct value which we want to compare to user answer.
     * @param userAnswer OBS.: this is STRGIN Object. The user input value.
     * @return The accuracy of this an attempt.
     */
